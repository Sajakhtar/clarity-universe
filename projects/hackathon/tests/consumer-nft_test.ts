...
//  *****************************************
// Sample - tests from Multisig contracts
...
function initContract({ chain, accounts, members = defaultMembers, votesRequired = defaultVotesRequired, stxVaultAmount = defaultStxVaultAmount }: initialContractOptions) {
